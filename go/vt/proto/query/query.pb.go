...
type RealtimeStats struct {
	...
	// query_timeout_rates is the rate of query timeouts per second in each of the last XX seconds
	// where XX is determined by (TODO: add the source of this value).
	QueryTimeoutRates []float64 `protobuf:"fixed64,9,rep,packed,name=query_timeout_rates,json=queryTimeoutRates,proto3" json:"query_timeout_rates,omitempty"`
}
...
func (x *RealtimeStats) GetQueryTimeoutRates() []float64 {
	if x != nil {
		return x.QueryTimeoutRates
	}
	return nil
}
...
var file_query_proto_rawDesc = []byte{
	...
	0x6d, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xa6,
	...
	0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x64, 0x12, 0x2e, 0x0a, 0x13, 0x71, 0x75, 0x65, 0x72, 0x79,
	0x5f, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x5f, 0x72, 0x61, 0x74, 0x65, 0x73, 0x18, 0x09,
	0x20, 0x03, 0x28, 0x01, 0x52, 0x11, 0x71, 0x75, 0x65, 0x72, 0x79, 0x54, 0x69, 0x6d, 0x65, 0x6f,
	0x75, 0x74, 0x52, 0x61, 0x74, 0x65, 0x73, 0x22, 0xf6, 0x01, 0x0a, 0x0e, 0x41, 0x67, 0x67, 0x72,
